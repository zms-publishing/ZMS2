...
class ZMSTeaserElement(ZMSObject): 
    ...
    def _getBodyContent(self, REQUEST):
      ...
      return self.rendershort_default( self, ob=self, url=url, url_title=url_title, target=target, title=title, text=text, bgcolor_title=bgcolor_title, bgcolor_text=bgcolor_text, REQUEST=REQUEST)
