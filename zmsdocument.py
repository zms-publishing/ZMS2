...
def manage_addZMSDocument(self, lang, _sort_id, REQUEST, RESPONSE):
...
class ZMSDocument(ZMSContainerObject):
    ...
    __authorPermissions__ = (
		...
		'manage_addZMSTextarea','manage_addZMSGraphic','manage_addZMSTable','manage_addZMSFile','manage_addZMSTeaserContainer','manage_addZMSNote','manage_addZMSLinkContainer','manage_addZMSLinkElement','manage_addZMSModule',
