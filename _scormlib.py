...
# _scormlib.py
#
# $Id: _scormlib.py,v 1.5 2004/11/24 21:02:52 zmsdev Exp $
# $Name:  $
# $Author: zmsdev $
# $Revision: 1.5 $
#
...
def getIMSManifestItems(self, REQUEST):
  ...
  if self.isActive( REQUEST):
    ...
    if self.meta_type=='ZMSCustom' or \
      ...
      if learningresourcetype is None or learningresourcetype == '':
        if self.meta_type in ['ZMSDocument','ZMSCustom']:
          learningresourcetype = 'lecture.document'
        elif self.meta_type in ['ZMSFolder','ZMSSysFolder']:
