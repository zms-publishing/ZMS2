...
class ZMSProxyObject(ZMSContainerObject):
    ...
    # --------------------------------------------------------------------------
    def __proxy__(self):
      if _globals.debug( self.base):
        _globals.writeLog( self.base, "[__proxy__]")
      return self
    ...
    def getObjAttrValue(self, obj_attr, REQUEST):
      if _globals.debug( self.base):
        _globals.writeLog( self.base, "[getObjAttrValue]")
      proxy = self.proxy
    ...
    def getDocumentElement(self):
      if _globals.debug( self.base):
        _globals.writeLog( self.base, "[getDocumentElement]")
      base = self.base
    ...
    def getHome(self):
      if _globals.debug( self.base):
        _globals.writeLog( self.base, "[getHome]")
      base = self.base
      rtn = base.getHome( )
      return rtn
    ...
    def getLevelnfc(self, REQUEST):
      if _globals.debug( self.base):
        _globals.writeLog( self.base, "[getLevelnfc]")
      proxy = self.proxy
    ...
    def getType(self):
      if _globals.debug( self.base):
        _globals.writeLog( self.base, "[getType]")
      proxy = self.proxy
