...
# $Revision: 1.2 $
#
# Implementation of class ZMSLog (see below).
# 
...
###   
################################################################################
def manage_addZMSLog(self, REQUEST=None, RESPONSE=None):
  """ manage_addZMSLog """
  obj = ZMSLog()
...
class ZMSLog(
    ...
    # -----------
    meta_type = 'ZMS Log'
    icon = 'misc_/SiteErrorLog/error.gif'
    ...
    manage_properties = HTMLFile( 'dtml/zmslog/manage_properties', globals())
