...
class ZMSNote(ZMSObject):
    ...
    #
    #  Always active.
    #  Overrides method from _objattrs.ObjAttrs.
    # --------------------------------------------------------------------------
    def isActive(self,REQUEST): return True

    # --------------------------------------------------------------------------
    #  ZMSNote.isVisible
    #
    #  Always invisible.
    #  Overrides method from zmsobject.ZMSObject.
    # --------------------------------------------------------------------------
    def isVisible(self,REQUEST): return False
    ...
    # --------------------------------------------------------------------------
    #  ZMSNote.getAutocommit
    #
    #  Overrides method from _workflowmanager.WorkflowItem.
    # --------------------------------------------------------------------------
    ...
    def renderShort(self, REQUEST):
      return self.rendershort_default(self,text=self.getObjProperty('text',REQUEST),REQUEST=REQUEST)
