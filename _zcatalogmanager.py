...
# ------------------------------------------------------------------------------
zcat_meta_types = ['ZMS','ZMSFolder','ZMSDocument','ZMSCustom','ZMSSysFolder','ZMSFile']
...
class ZCatalogItem(CatalogAwareness.CatalogAware): 
    ...
    def isCatalogItem(self):
      b = False
      b = b or (self.isPage() or self.meta_type == 'ZMSFile')
