...
class ConfManager(
    ...
    # --------------------------------------------------------------------------
    def customize_manage_options(self, lang, REQUEST):
      options = []
      options.append({'label':self.getZMILangStr('TAB_SYSTEM'),'action':'manage_customize'})
      options.append({'label':self.getZMILangStr('TAB_LANGUAGES'),'action':'manage_customizeLanguagesForm'})
      options.append({'label':self.getZMILangStr('TAB_METADATA'),'action':'manage_customizeMetadictForm'})
      options.append({'label':self.getZMILangStr('TAB_METAOBJ'),'action':'manage_customizeMetaobjForm'})
      options.append({'label':self.getZMILangStr('TAB_METACMD'),'action':'manage_customizeMetacmdForm'})
      options.append({'label':self.getZMILangStr('TAB_WORKFLOW'),'action':'manage_customizeWorkflowForm'})
      options.append({'label':self.getZMILangStr('TAB_TEXTFORMAT'),'action':'manage_customizeTextFormatForm'})
      options.append({'label':self.getZMILangStr('TAB_FILTER'),'action':'manage_customizeFilterForm'})
      options.append({'label':self.getZMILangStr('TAB_DESIGN'),'action':'manage_customizeDesignForm'})
      return options
