...
def exportFilter(self, id, REQUEST):
  ...
  ressources = self.exportRessources( tempfolder, REQUEST, from_content=True, from_zms=ob_filter_format=='XHTML', from_common=ob_filter_format=='XHTML', incl_embedded=incl_embedded)
